...
if (isset($_POST['submit'])) {
    ...
    $login = mysqli_query($koneksi, "SELECT * FROM penjual WHERE username='$username' AND password ='$password'");
    ...
    if ($hasil > 0) {
        ...
        $_SESSION['id_penjual'] = $r['id_penjual'];
        $_SESSION['nama_toko'] = $r['nama_toko'];
        header('Location: utama.php?page=product'); // Redirect ke halaman produk
        exit;
    } else {
