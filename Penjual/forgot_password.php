...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM penjual WHERE email='$email'");
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        if ($new_password === $confirm_password) {
            ...
            $update_query = mysqli_query($koneksi, "UPDATE penjual SET password='$hashed_password' WHERE email='$email'");
